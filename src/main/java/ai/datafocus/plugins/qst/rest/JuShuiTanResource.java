...
public class JuShuiTanResource {
  ...
  public OrderQueryResult getOrders(OrderQueryBody orderQueryBody) throws JsonMappingException, JsonProcessingException {
    JstPartnerData jstPartnerData = myconfig.getInstanceConfig();
    long ts = System.currentTimeMillis() / 1000;
    String result = jushuitanService.queryOrder(
        ORDER_METHOD_NAME,
